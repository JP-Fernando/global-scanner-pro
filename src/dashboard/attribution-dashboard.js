...
export class AttributionDashboard {
  ...
  async initialize(portfolio) {
    ...
    try {
      ...
      const benchmarkReturns = benchmarkPrices.map(p => ({
        date: p.date,
        value: p.price
      }));
    ...
    return `
      <div class="brinson-analysis">
        ...
        <div class="interpretation-box">
          ...
          ${brinson.interpretation.map(text => `<p>• ${text}</p>`).join('')}
        </div>
        ...
        <div class="sector-breakdown">
          ...
          <table class="attribution-table">
            ...
            <tbody>
              ${brinson.allocation_effect.by_sector.map(sector => `
                <tr>
                  <td>${sector.sector}</td>
        ...
        <div class="sector-breakdown">
          ...
          <table class="attribution-table">
            ...
            <tbody>
              ${brinson.selection_effect.by_sector.map(sector => `
                <tr>
                  <td>${sector.sector}</td>
   ...
   */
  renderFactorContributors(factorName, contributors) {
    return `
      ...
      <div class="asset-analysis">
        ...
        <div class="asset-section">
          ...
          <table class="attribution-table">
            ...
            <tbody>
              ${assets.top_contributors.map(asset => `
                <tr>
                  <td><strong>${asset.ticker}</strong></td>
                  <td>${asset.name}</td>
                  <td>${asset.sector}</td>
        ...
        ${assets.top_detractors.length > 0 ? `
          <div class="asset-section">
            ...
            <table class="attribution-table">
              ...
              <tbody>
                ${assets.top_detractors.map(asset => `
                  <tr>
                    <td><strong>${asset.ticker}</strong></td>
                    <td>${asset.name}</td>
                    <td>${asset.sector}</td>
      ...
      <div class="period-analysis">
        ...
        <div class="period-section">
          ...
          <table class="attribution-table">
            ...
            <tbody>
              ${periods.monthly.slice(-12).reverse().map(period => `
                <tr>
                  <td>${period.period}</td>
        ...
        <div class="period-section">
          ...
          <table class="attribution-table">
            ...
            <tbody>
              ${periods.quarterly.reverse().map(period => `
                <tr>
                  <td>${period.period}</td>
                  <td class="${period.portfolio_return >= 0 ? 'positive' : 'negative'}">
                    ${period.portfolio_return >= 0 ? '+' : ''}${period.portfolio_return.toFixed(2)}%
