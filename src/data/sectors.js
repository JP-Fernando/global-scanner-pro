 ...
 */
 export function getSectorId(providerString) {
 ...
 */
export function calculateSectorStats(assets) {
  const sectorStats = {}; // { 100: { avgVolume: 50000, avgRsi: 55, count: 20 }, ... }

  // 1. Agrupar y sumar
  assets.forEach(asset => {
    const sId = asset.sectorId || 999;
